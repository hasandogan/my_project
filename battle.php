    ...
    <body>
        <div class="container">
            ...
            <div class="result-box center-block">
                <h3 class="text-center audiotape">
                    Winner:
                    <?php if ($battleResult->isThereAWinner()): ?>
                        <?php echo $battleResult->getWiningShip()->getName(); ?>
                    <?php else: ?>
                        Nobody
                    <?php endif; ?>
                </h3>
                <p class="text-center">
                    ...
                    <?php else: ?>
                        The <?php echo $battleResult->getWiningShip()->getName(); ?>
